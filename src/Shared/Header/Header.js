    ...
    return (
        <div className="navbar bg-base-100">
            ...
            <div class="navbar-end">
                <a href="https://drive.google.com/file/d/15wdFPYjFj_ojy_8HAIqo0lLMpd5H3zCi/view?usp=sharing"
                    target="_blank" rel="noreferrer" class="btn btn-primary">Download Resume</a>
            </div>
        </div>
    );
};
